...
<section class="postText">
	...
	<p class="prev_page"><a href="index.php?action=adminSchedule"> Retour à la liste des actualités !</a></p>
	...
	<div id="deleteLink">
	    <a href="index.php?action=deleteSchedule&amp;id={{_get.id}}"> Supprimer l'actualité</a>
	</div>
